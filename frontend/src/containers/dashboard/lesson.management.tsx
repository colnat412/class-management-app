...
import { AddLessonRequest, Lesson } from '@/types/lesson.interface';
import { BookUp, Edit, Loader2, Plus, Search, Trash2 } from 'lucide-react';
...
const LessonManagement = () => {
  ...
  return (
    <div className="flex flex-col gap-4 h-full w-full p-6">
      <h1 className=" text-2xl">Manage Lesson</h1>
